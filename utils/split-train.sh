...
# from https://s3.us-east-2.amazonaws.com/propaganda-datathon/dataset/datasets-v3.zip
# and that you have unzipped it in datasets-v3_1 (you can also edit $DATA_DIR)

export DATA_DIR=datasets-v3_1
...
cat *.task3.labels > ../train-dev.task3.labels || exit 12
cd ../../..
cp $DATA_DIR/propaganda-techniques-names.txt $TRAIN_SPLIT_DIR/tasks-2-3/propaganda-techniques-names.txt || exit 13
